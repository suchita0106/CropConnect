 ...
 */
package userinterface.FruitSupplierRole;

import userinterface.VegetableSupplierRole.*;
import userinterface.FruitSupplierRole.*;
...
import userinterface.ViewDetails.FruitSupplierViewJPanel;

/**
 *
 * @author sakshee
 */
public class FruitSupplierWorkAreaJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private EcoSystem business;
    private Enterprise enterprise;
    private UserAccount userAccount;
    private FruitSupplierOrganization fruitSupplierOrganization;
    
    /**
     * Creates new form LabAssistantWorkAreaJPanel
     */
    public FruitSupplierWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business) {
        initComponents();
        ...
        this.fruitSupplierOrganization = (FruitSupplierOrganization)organization;
    ...
    public void populateTable(){
        ...
        for(WorkRequest request : fruitSupplierOrganization.getWorkQueue().getWorkRequestList()){
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        FruitWorkRequest request = (FruitWorkRequest)workRequestJTable.getValueAt(selectedRow, 0);    
     
        request.setStatus("Processing");
        
        FruitProcessWorkRequestJPanel processWorkRequestJPanel = new FruitProcessWorkRequestJPanel(userProcessContainer, request);
    ...
    private void viewDetailsjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailsjButton1ActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            FruitWorkRequest request = (FruitWorkRequest)workRequestJTable.getValueAt(selectedRow, 0);
            FruitSupplierViewJPanel panel = new FruitSupplierViewJPanel(userProcessContainer, request);
            userProcessContainer.add("FruitSupplierViewJPanel",panel);
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
            layout.next(userProcessContainer);
        }
