 ...
 * @author sakshee
 */
public class FertlizerSupplierWorkAreaJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private EcoSystem business;
    private Enterprise enterprise;
    private UserAccount userAccount;
    private FertlizerSupplierOrganization fertlizerSupplierOrganization;
    
    /**
     * Creates new form LabAssistantWorkAreaJPanel
     */
    public FertlizerSupplierWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business) {
        initComponents();
        ...
        this.fertlizerSupplierOrganization = (FertlizerSupplierOrganization)organization;
    ...
    public void populateTable(){
        ...
        for(WorkRequest request : fertlizerSupplierOrganization.getWorkQueue().getWorkRequestList()){
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        ProcessFertilzerWorkRequestJPanel processWorkRequestJPanel = new ProcessFertilzerWorkRequestJPanel(userProcessContainer, request);
        userProcessContainer.add("ProcessFertilzerWorkRequestJPanel", processWorkRequestJPanel);
