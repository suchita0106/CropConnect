 ...
 */
package userinterface.MilkSupplierRole;

import userinterface.VegetableSupplierRole.*;
...
import userinterface.ViewDetails.MilkSupplierViewJPanel;
 ...
 * @author sakshee
 */
public class MilkSupplierWorkAreaJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private EcoSystem business;
    private Enterprise enterprise;
    private UserAccount userAccount;
    private MilkSupplierOrganization seedSupplierOrganization;
    
    /**
     * Creates new form LabAssistantWorkAreaJPanel
     */
    public MilkSupplierWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business) {
        initComponents();
        ...
        this.seedSupplierOrganization = (MilkSupplierOrganization)organization;
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        MilkWorkRequest request = (MilkWorkRequest)workRequestJTable.getValueAt(selectedRow, 0);    
     
        request.setStatus("Processing");
        
        MilkProcessWorkRequestJPanel processWorkRequestJPanel = new MilkProcessWorkRequestJPanel(userProcessContainer, request);
        userProcessContainer.add("MilkProcessWorkRequestJPanel", processWorkRequestJPanel);
    ...
    private void viewDetailsjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailsjButton1ActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            MilkWorkRequest request = (MilkWorkRequest)workRequestJTable.getValueAt(selectedRow, 0);
            MilkSupplierViewJPanel panel = new MilkSupplierViewJPanel(userProcessContainer, request);
            userProcessContainer.add("MilkSupplierViewJPanel",panel);
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
            layout.next(userProcessContainer);
        }
