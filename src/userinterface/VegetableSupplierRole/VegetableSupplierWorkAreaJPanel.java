...
import userinterface.ViewDetails.VegetableSupplierViewJPanel;
...
public class VegetableSupplierWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private VegetableSupplierOrganization vegetableSupplierOrganization;
    
    /**
     * Creates new form LabAssistantWorkAreaJPanel
     */
    public VegetableSupplierWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business) {
        initComponents();
        ...
        this.vegetableSupplierOrganization = (VegetableSupplierOrganization)organization;
    ...
    public void populateTable(){
        ...
        for(WorkRequest request : vegetableSupplierOrganization.getWorkQueue().getWorkRequestList()){
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        VegetableWorkRequest request = (VegetableWorkRequest)workRequestJTable.getValueAt(selectedRow, 0);    
     
        request.setStatus("Processing");
        
        VegetableProcessWorkRequestJPanel processWorkRequestJPanel = new VegetableProcessWorkRequestJPanel(userProcessContainer, request);
    ...
    private void viewDetailsjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailsjButton1ActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            VegetableWorkRequest request = (VegetableWorkRequest)workRequestJTable.getValueAt(selectedRow, 0);
            VegetableSupplierViewJPanel panel = new VegetableSupplierViewJPanel(userProcessContainer, request);
            userProcessContainer.add("VegetableSupplierViewJPanel",panel);
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
            layout.next(userProcessContainer);
        }
