 ...
 * @author suchita
 */
public class LRManageOrganizationJPanel extends javax.swing.JPanel {
     ...
     */
    public LRManageOrganizationJPanel(JPanel userProcessContainer,OrganizationDirectory directory) {
        initComponents();
    ...
    private void populateCombo(){
        ...
        for (Type type : Organization.Type.values()){
             if (type.getValue().equals(Type.LocalRestaurantsOrganization.getValue()))
