...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo(){
        ...
        for (Type type : Organization.Type.values()){
             if (type.getValue().equals(Type.SeedSupplierOrganization.getValue())||type.getValue().equals(Type.FertlizerSupplierOrganization.getValue())
                     ||type.getValue().equals(Type.EquipmentSupplierOrganization.getValue()))
