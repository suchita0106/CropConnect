 ...
 * @author suchita
 */
public class FertilizerSupplierViewJPanel extends javax.swing.JPanel {
    ...
    public FertilizerSupplierViewJPanel(JPanel userProcessContainer,FertilizerWorkRequest request ) {
        initComponents();
        this.userProcessContainer=userProcessContainer;
        this.request=request;
        NameJTextField.setText(request.getFertilizerName());
